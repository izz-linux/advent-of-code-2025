...
[View full problem on Advent of Code](https://adventofcode.com/2025/day/2)

## Solution Approach

The solution employs input parsing and conversion, iteration over data structures to efficiently solve the problem.
